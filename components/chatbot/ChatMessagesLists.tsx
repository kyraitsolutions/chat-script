...
import {
  createSession,
  deleteSession,
  getAllSessionsByChatbot,
} from "@/utils/chatbot/chatbotIndexDb";
        ...
        {messages?.length > 0 ? (
          messages?.map((msg) => (
            <div
              ...
              className="group flex items-center gap-3 px-4 py-3 border-b border-gray-100 last:border-b-0 cursor-pointer transition bg-gray-100 hover:bg-gray-200 active:bg-gray-100 rounded-sm"
            >
              {/* AVATAR */}
              <div className="relative flex-shrink-0">
                <div className="w-10 h-10 rounded-full bg-linear-to-br from-gray-200 to-gray-300 flex items-center justify-center text-sm font-semibold text-gray-600">
              ...
              {/* DELETE BUTTON */}
              <button
                onClick={(e) => handleDeleteSession(e, msg.sessionId)}
                className="
      ...
      <div className="p-4 border-t border-gray-100 bg-white">
        <button
          ...
          style={{
            ...
            color: chatbotData?.theme?.userMessageColor || "#ffffff",
          }}
          onClick={handleClickAskQuestions}
          className=" cursor-pointer w-full flex items-center justify-center gap-2 text-white px-5 py-3 rounded-full text-sm font-semibold shadow-md active:scale-[0.98] transition"
        >
          Ask a question
...
//   getAllSessionsByChatbot,
// } from "@/utils/chatbot/chatbotIndexDb";
// import { setSessionId } from "@/utils/chatbot/chatbotSessions";
// import { formatRelativeTime } from "@/utils/dateTime";
// import { useEffect, useState } from "react";
// import { set } from "zod";
...
//   const { setView, setActiveSessionId, chatbotData } = useChatbotContext();
//   const [messages, setMessages] = useState<MessageItem[] | []>([]);
...
//         <button
//           onClick={handleClickAskQuestions}
//           className=" cursor-pointer w-full flex items-center justify-center gap-2  bg-green-600 text-white px-5 py-3 rounded-full text-sm font-semibold shadow-md  hover:bg-green-700 active:scale-[0.98] transition"
//         >
//           Ask a question
